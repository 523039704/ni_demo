    ...
    <div class="mainer">
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                <li class="active"><a href="${pageContext.request.contextPath}/" class="icon-home"> 开始</a>
                    <ul><li><a href="#">系统设置</a></li><li><a href="/user">内容管理</a></li><li><a href="#">订单管理</a></li><li class="active"><a href="#">会员管理</a></li><li><a href="#">文件管理</a></li><li><a href="#">栏目管理</a></li></ul>
                </li>

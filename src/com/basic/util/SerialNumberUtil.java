...
//		if (MigrStringUtil.isNotEmpty(lastOrderSn)) {
//			lastOrderSnNumber = Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastOrderSn, ORDER_SN_PREFIX));
//		} else {
...
//		if (MigrStringUtil.isNotEmpty(lastPaymentSn)) {
//			lastPaymentSnNumber = Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastPaymentSn, PAYMENT_SN_PREFIX));
//		} else {
...
//		if (MigrStringUtil.isNotEmpty(lastRefundSn)) {
//			lastRefundSnNumber = Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastRefundSn, REFUND_SN_PREFIX));
//		} else {
...
//		if (MigrStringUtil.isNotEmpty(lastShippingSn)) {
//			lastShippingSnNumber = Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastShippingSn, SHIPPING_SN_PREFIX));
//		} else {
...
//		if (MigrStringUtil.isNotEmpty(lastReshipSn)) {
//			lastReshipSnNumber = Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastReshipSn, RESHIP_SN_PREFIX));
//		} else {
